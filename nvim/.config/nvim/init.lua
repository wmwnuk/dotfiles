...
-- Pandoc
utils.noremap('n', '<leader>pop', '<Cmd>!pandoc -f org -t pdf -o %.pdf %<CR><C-j>', opts)
utils.noremap('n', '<leader>pmp', '<Cmd>!pandoc -f markdown -t pdf -o %.pdf %<CR><C-j>', opts)
utils.noremap('n', '<leader>pom', '<Cmd>!pandoc -f org -t markdown -o %.md %<CR><C-j>', opts)
utils.noremap('n', '<leader>poh', '<Cmd>!pandoc -f org -t html -o %.html %<CR><C-j>', opts)
utils.noremap('n', '<leader>pmh', '<Cmd>!pandoc -f markdown -t html -o %.html %<CR><C-j>', opts)
utils.noremap('n', '<leader>pmo', '<Cmd>!pandoc -f markdown -t org -o %.md %<CR><C-j>', opts)
utils.noremap('n', '<leader>pho', '<Cmd>!pandoc -f html -t org -o %.org %<CR><C-j>', opts)
utils.noremap('n', '<leader>phm', '<Cmd>!pandoc -f html -t markdown -o %.md %<CR><C-j>', opts)
